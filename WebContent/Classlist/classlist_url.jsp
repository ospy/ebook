		...
		<div class="col_right">
			<table class="limit">
				<tr class="clinic_tr  classlist">
					<td class="top item"><a id="1" href="/Classlist/classlist.jsp?classid=1">临床医学</a>：</td>
				...
				<tr class="basic_tr classlist">
					<td class="top item"><a id="2" href="/Classlist/classlist.jsp?classid=2">基础医学</a>：</td>
				...
				<tr class="pharmacy_tr classlist">
					<td class="top item"><a id="3"  href="/Classlist/classlist.jsp?classid=3">药&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;学</a>：</td>
		...
		function selectClass(){
			...
			if(classid==0||classid==""||classid==null){
				...
				$(".selected").each(function(){
					currlimit+=$(this).html()+" and ";			
					});
				currlimit=currlimit.substr(0,currlimit.length-4); 
			    }
         ...
         function getClassList(classid,pageIndex){
		     ...
		     order =$(".actived").attr("data");
	            ...
	            $.ajax({
	                ...
	                contentType: "application/x-www-form-urlencoded; charset=UTF-8",
	                dataType: 'json',
	                data: {search:search, spid:classid,startTime:startTime,endTime:endTime,pageIndex:pageIndex,pageListSize:pageListSize,order:order },
	                success: function (result) {
	                	$("#discuList").html("");
	                	if (result != 0) {
	                	var str = "";
