...
<body>
	<div class="main">
		...
		<div class="mainbox">
			...
			<script type="text/javascript">
			jQuery("#recommand").slide({titCell:".hd ul",mainCell:".bd ul",autoPage:true,effect:"left",vis:5,scroll:5,pnLoop:"false"});
		</script>
